...
#
# install_zabbix6.sh - Sript instalação e configuração do Zabbix 6 stable (Recomendação 20.04 LTS ou superior)
#
# Website:       https://www.linkedin.com/in/domcabral/
# Autor:         André Cabral (Dom Cabral)  
#
# ------------------------------------------------------------------------ #
#
# COMO USAR?
...
case "$RELEASE" in
    bionic)
        echo "É UBUNTU 18.04 BIONIC CONTINUANDO"
        sleep 2
